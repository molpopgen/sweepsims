...
int main( int argc, char **argv )
{
  if(argc != 11)
    {
      cerr << "sweep_stochCG: single sweep at time tau. Stochastic trajectories using method of Coop and Griffiths\n"
	   << "usage: sweep_stochCG nsam nreps N 2Ns tau X rho_site nsites theta_site seed\n"
	   << "where:\n"
